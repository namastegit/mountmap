...
<button className='bg-black flex justify-center items-center  h-8 xl:h-12 xl:w-full text-[8px]  md:h-10 text-white rounded-full md:text-xl md:font-normal p-2 md:p-2 w-3/6 sm:w-2/6 md:w-3/6 lg:w-4/6 xl:scale-110 dark:text-black dark:bg-white hover:bg-green-600 dark:hover:bg-green-600'><div>Join Now</div> </button>
</div>
